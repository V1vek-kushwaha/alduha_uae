            ...
            <div className="row align-items-center justify-content-center">
              <div className="col-xl-6 col-lg-10">
                <div className="section__title text-center mb-50">
                  <span className="sub-title text-anim">Testimonials</span>
                  <h2 className="title text-white text-anim2">
                    What Our Users Said About Al-Duha
                  </h2>
                  <p className="sec-text text-white">
                    Our AI business co-pilot is engineered to function not just
                    as a standalone solution but as a central part of your
                    digital ecosystem.
                  </p>
