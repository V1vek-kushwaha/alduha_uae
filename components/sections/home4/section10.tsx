...
export default function Section10() {
  ...
  const testimonials = [
    {
      text: "Working with Al-Duha has been a game-changer for our organization. Their team took the time to understand our unique challenges and developed a customized strategy that helped us streamline our operations and boost efficiency",
        ...
        <div className="container">
          ...
          <div className="testimonial-wrap2">
            <div className="testimonial-thumb2">
              <img
                src="/assets/img/testimonial/testimonial-thumb-2.png"
                alt="img"
              />
            </div>
                    ...
                    <SwiperSlide key={`author-${index}`}>
                      <div className="testimonial-author-card2">
                        ...
                        <div className="media-body">
                          <h4 className="testimonial-card-title">
                            {testimonial.author}
                          </h4>
