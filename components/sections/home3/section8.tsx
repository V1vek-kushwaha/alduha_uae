          ...
          <div className="row gy-30 justify-content-center">
            <div className="col-xl-4 col-md-6">
              <div className="pricing-card">
                <div className="pricing-card_thumb">
                  <img
                    src="/assets/img/others/pricing-thumb1-1.png"
                    alt="img"
                  />
                ...
                <div className="pricing-card_details">
                  ...
                  <p className="pricing-card_text">
                    Perfect for startups or small businesses looking to set a
                    strong foundation.
                  </p>
                  <div className="checklist">
                    <ul className="list-wrap">
                      <li>
                        <i className="fas fa-check" /> Business initial
                        assessment check{" "}
                      </li>
                      <li>
                        <i className="fas fa-check" /> Customized strategic
                        roadmap
                      </li>
                      <li>
                        <i className="fas fa-check" /> Monthly consultation (4
                        hours/month)
                      </li>
                      <li>
                        <i className="fas fa-check" /> Access to basic resources
                      </li>
                    </ul>
                  </div>
                  <div className="tg-button-wrap justify-content-center">
                    <Link href="/#" className="btn w-100">
                      <span className="btn-text" data-text="Purchase Plan" />
                    </Link>
                  </div>
                </div>
              </div>
            ...
            <div className="col-xl-4 col-md-6">
              <div className="pricing-card active">
                <div className="pricing-card_thumb">
                  ...
                  <img
                    src="/assets/img/others/pricing-thumb1-2.png"
                    alt="img"
                  />
                  <h4 className="pricing-card_price">
                    <span className="currency">$</span>5,000
                    <span className="duration">/month</span>
                  </h4>
                </div>
                <div className="pricing-card_details">
            ...
            <div className="col-xl-4 col-md-6">
              <div className="pricing-card">
                <div className="pricing-card_thumb">
                  <img
                    src="/assets/img/others/pricing-thumb1-3.png"
                    alt="img"
                  />
                  <h4 className="pricing-card_price">
