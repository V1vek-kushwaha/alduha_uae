                ...
                <div className="col-xl-3 col-lg-4 col-md-6">
                  <div className="footer__widget">
                    <div className="footer__location">
                      ...
                      <h5 className="footer__location-title">
                        New York Office
                      </h5>
                      <ul className="list-wrap">
                        <li>
                          123 Broadway, Suite 1000 New York, NY 10001, USA
                        </li>
                        <li>
                          <Link href="/mailto:info@Al-Duha-nyk.com">
                            info@Al-Duha-nyk.com
                          </Link>
                        </li>
                        <li>
                          <Link href="/tel:2582468632125">
                            +258 24686 32125
                          </Link>
                        </li>
                      </ul>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6">
                  <div className="footer__widget">
                    <div className="footer__location">
                      ...
                      <ul className="list-wrap">
                        <li>
                          890 Peachtree Street NE, Suite 500 Atlanta GA 30309,
                          USA
                        </li>
                        <li>
                          <Link href="/mailto:info@Al-Duha-bst.com">
                            info@Al-Duha-bst.com
                          </Link>
                        </li>
                        <li>
                          <Link href="/tel:2582468632125">
                ...
                <div className="col-xl-3 col-lg-4 col-md-6">
                  <div className="footer__widget">
                    <div className="footer__location">
                      ...
                      <ul className="list-wrap">
                        <li>
                          67 Hercht, 1e verdieping Amsterdam, 1015 BT,
                          Netherlands.
                        </li>
                        <li>
                          <Link href="/mailto:info@Al-Duha-ams.com">
                            info@Al-Duha-ams.com
                          </Link>
                        </li>
                        <li>
                          <Link href="/tel:2582468632125">
                ...
                <div className="col-xl-3 col-lg-4 col-md-6">
                  <div className="footer__widget">
                    <div className="footer__location">
                      ...
                      <ul className="list-wrap">
                        <li>
                          89 Kunggatan, Vaning 4 Stockholm, 111 22, Sweden.
                        </li>
                        <li>
                          <Link href="/mailto:info@Al-Duha-ams.com">
                            info@Al-Duha-stk.com
                          </Link>
                        </li>
                        <li>
                          <Link href="/tel:2582468632125">
                ...
                <div className="row justify-content-lg-between justify-content-center gy-2">
                  <div className="col-auto">
                    <div className="footer__copyright text-center">
                      Copyright ©<Link href="#">Al-Duha</Link> 2025. All Rights
                      Reserved.
                    </div>
                  </div>
                  <div className="col-auto">
                    <div className="footer__bottom-links">
                      <ul className="list-wrap">
                        <li>
                          <Link href="/blog">Company news</Link>
                        </li>
                        <li>
