                ...
                <div className="row justify-content-between">
                  <div className="col-xl-3 col-lg-4 col-md-6">
                    <div className="footer__widget footer__about">
                      ...
                      <p className="footer__content mb-35">
                        Venenatis egestas fames cum erat duis cubilia sagittis
                        vivamus ultrices magnis proin inceptos
                      </p>
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="footer__widget footer__newsletter">
                      ...
                      <p className="footer__content mb-35">
                        Curabitur aliquet quam posuere blandit ellentesque
                        insdorci ipsum id orci porta dapibus...
                      </p>
                      <form className="footer__newsletter-form" action="#">
                        ...
                        />
                        <button className="btn btn-five" type="submit">
                          Subscribe
                        </button>
                      </form>
                    </div>
            ...
            <div className="footer__bottom text-center">
              <div className="container">
                <div className="footer__copyright">
                  © 2024 Copyrights by <Link href="#">Al-Duha</Link>. All Rights
                  Reserved.
                </div>
              </div>
            </div>
