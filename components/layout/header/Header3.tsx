							...
							<div className="row">
								...
								<div className="col-xl-6 col-md-4">
									<ul className="tg-header__top-right list-wrap">
										<li>
											<div className="tg-header__top-links">
                      ...
                      <div className="tgmenu__navbar-wrap tgmenu__main-menu d-none d-lg-flex">
                        <ul className="navigation">
                          ...
                          <li className="menu-item-has-children">
                            ...
                            <ul className="sub-menu">
                              <li>
                                <Link href="#">Ongoing Promotions</Link>
                              </li>
                              <li>
                                <Link href="#">Expert Columns</Link>
                              </li>
                              <li>
                                <Link href="#">BizCast by Al-Duha</Link>
                              </li>
                            </ul>
                          </li>
                          <li className="menu-item-has-children">
                            ...
                            <ul className="sub-menu">
                              <li>
                                <Link href="#">Business Centers </Link>
                              </li>
                              <li>
                                <Link href="#">Tax & Accounting</Link>
                              </li>
                              <li>
                      ...
                      <div className="tgmenu__action d-none d-md-block">
                        <ul className="list-wrap">
                          <li>
                            <Link
                              href="#"
                              className="btn btn-three menu-tigger"
                            >
                              <span
                                className="btn-text"
