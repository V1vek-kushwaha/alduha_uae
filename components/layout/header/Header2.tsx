    ...
    <>
      <header>
        <div className="transparent-header">
          <div className="tg-header__top tg-header__top-three d-lg-block d-none">
                ...
                <div className="col-xl-6 col-md-8">
                  <ul className="tg-header__top-info left-side list-wrap">
                    <li>
                      ...
                      driven and motivated 1st Line Business Solution?
                    </li>
                  </ul>
                </div>
          ...
          <div className="tg-header__middle tg-header__middle-two d-lg-block d-none bg-transparent">
            <div className="container">
              <div className="row">
                <div className="col-12">
                  <div className="tgmenu__wrap">
                    <nav className="tgmenu__nav">
                      ...
                      <div className="info-card-wrap style2">
                        <div className="info-card">
                          ...
                          <div className="info-card_content">
                            ...
                            <Link
                              href="/mailto:inside@Al-Duha.com"
                        ...
                        <div className="info-card">
                          ...
                          <div className="info-card_content">
                            ...
                            <p className="info-card_link">452 Marie Avenue</p>
                          </div>
                        </div>
                        <div className="divider" />
                        <div className="info-card">
